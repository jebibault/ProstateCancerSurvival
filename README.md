...
XGBoost was used to predict the risk to die from prostate cancer within 10 years after diagnosis. Hyperparameters were tuned with Bayesian Optimization in a nested cross-validation manner. Performances were evaluated on the test dataset.
...
model
- 10yCSSmodel.pkl - the XGBoost model in pickle format
