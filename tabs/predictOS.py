...
layout = html.Div([
  html.P([html.Br()]),
  html.P([html.Br()]),
  dcc.Markdown('#### Please answer these 30 questions to predict the risk to die from any other cause 10 years after prostate cancer diagnosis.'),
  ...
  html.Div(id='OSprediction-content', style={'fontWeight': 'bold', 'color': '#820000', 'font-size': 'large', 'text-align': 'center'}),
...
@app.callback(
    Output('OSprediction-content', 'children'),
